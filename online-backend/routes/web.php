...
Route::post('api/articles/create/{id}', 'ArticleController@store');
Route::get('/api/shop/{id}/articles', 'ShopsController@findArticle');
...
Route::get('/api/shops-more', 'ShopsController@getMore');